...
// const findOrange = function (v) {
//     return v.color == "orange"
// }
// const veg = vegetables.filter(findOrange)
// console.log(veg)
...
// ex-1
const newArray = users.map(u => { return { email: u.email, companyName: u.company.name } })
...
const zipStart5 = function (u) {
    return u.address.zipcode.charAt(0) === '5'

}

const findZip = users.filter(zipStart5)
// console.log(findZip)
